    ...
    <div class="d-flex">
        <div class="dropdown flex-fill px-4 px-sm-0">
            <a class="btn btn-light dropdown-toggle" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">Filtrele
                <span style="color:#f2be00;">{{ sort }}</span>
            </a>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item" @click="sortBy('newset')" value="newset">En yeniden En eskiye</a>
                <a class="dropdown-item" @click="sortBy('price')" value="price">Fiyata Göre</a>
                <a class="dropdown-item" @click="sortBy('trending')" value="trending">En Popüler</a>
            </div>
        </div>
        <div class="dropdown d-block d-lg-none d-xl-none px-4 px-sm-0">
            <button class="btn btn-light dropdown-toggle" role="button" id="MenuLink" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">Kategoriler</button>
