  ...
  <section>
    <div class="container-fluid py-5">
      <div class="row d-flex">
        <div class="col-12 col-xl-8 col-lg-7 col-md-7 col-sm-12 order-sm-0 order-12" style="margin-right:-120px;">
          <img class="custom-logo" src="@/assets/pixalogo.png" alt="logo" title="logo">
        </div>
        <div class="col-12 col-xl-6 col-lg-5 col-md-6 col-sm-12 order-first order-xl-0">
          <h1>Merhaba</h1>
          <h2 style="color:grey">Öneri veya Şikayet</h2>
          <form>
            ...
            <button class="btn btn-light" href="#" role="button">Gönder</button>
          </form>
        </div>
      </div>
    </div>
